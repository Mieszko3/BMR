    ...
    <section>
        <article>
            <div class="user">
                ...
                Nasza strona jest to okazja do początkowego rozpoznania z kim możesz zapoznać się już na żywo w naszej szkole ZSHT. Zapraszamy do zarejestrwoania się i życzymy miłej zabawy <br> Do zobaczenia!&#128075;
            </div>
        </article>
    </section>
    <aside></aside>
